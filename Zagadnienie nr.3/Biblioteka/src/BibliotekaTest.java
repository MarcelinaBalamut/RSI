...
public class BibliotekaTest
{
    ...
    public static void main(String[] args)
    {
        ...
        ksiazki[1]=new Ksiazka("Zofia Nałkowksa", "Granica", false, true,Okladka.MIEKKA);
        ksiazki[2]=new Ksiazka("WisławaSzymborska", "Wiersze", true,false,Okladka.TWARDA);
        ksiazki[3]=new Ksiazka("Ewa Nowak", "Zdrowie i uroda", true,false,Okladka.MIEKKA);
        ksiazki[4]=new Ksiazka("Adam Mickiewicz ", "Dziady", true,false,Okladka.TWARDA);
        ksiazki[5]=new Ksiazka("Bolesław Prus", "Lalka", true,true,Okladka.MIEKKA);
